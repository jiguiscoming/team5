...
<body>
	...
	<form action="joinusC" method="post" name="account"
		...
		<table>
			...
			<tr>
				<td>닉네임</td>
				<td><input name="join_nick" placeholder="닉네임을 입력하세요" value="${join_name }"></td>
			</tr>
			...
			<tr>
				...
				<td><input name="join_age" type="number"
					placeholder="나이를 입력하세요"" value="${join_name }"></td>
			</tr>
			...
			<tr>
				...
				<td><input name="join_birth"
					placeholder="주민등록상으로 기재된 생년월일을 입력해 주세요" value="${join_name }"></td>
			</tr>

			<!-- jquery 필요 -->
			<tr>
				<td>아이디</td>
				<td><input id="join_id" name="join_id"  value="${join_name }"
			...
			<tr>
				<td>비밀번호</td>
				<td><input type="password" name="join_pw" value="${join_name }"
			...
			<tr>
				<td>비밀번호 확인</td>
				<td><input type="password" name="join_pw2" value="${join_name }"
			...
			<tr>
				<td>답변</td>
				<td><input name="join_pwquestiona" value="${join_name }"<%--  placeholder="${비밀번호확인질문 }" --%>></td>
			</tr>


			<tr>
				<td>이메일</td>
				<td><input name="join_email"  value="${join_name }" type="email"
			...
			<tr>
				<td>휴대폰</td>
				<td><input name="join_phone"  value="${join_name }" placeholder="전화번호를 입력하세요"></td>
			</tr>
